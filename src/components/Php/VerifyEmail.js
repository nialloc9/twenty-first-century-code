...
export default () => {
    const data = [
        ...
        {
            type: 'source',
            href: 'https://github.com/nialloc9/emailAuthenticate'
        },
        {
            type: 'paragraph',
            text: `Inside the database schema there are two tables. One holds the user data while the other is used for storing the data
...
?>
        ...
        {
            type: 'paragraph',
            text: `From this we can see that the class Auth has five methods, all responsible for updating or checking different
        ...
        {
            type: 'paragraph',
            text: `The verifyEmailRequestConfirmation method confirms that the information provided by the user when
        ...
        {
            type: 'paragraph',
            text: `Lastly we have two other functions that are important. The verify emailIsActivated which checks to see if the
        ...
        {
            type: 'paragraph',
            text: `Now let’s look at the script that handles the http requests sent from the client in relation to email authentication:`
        },
        {
            type: 'code',
            language: 'php',
...
?>
        ...
        {
            type: 'paragraph',
            text: `First, we require our connect script and the auth.controller script which we discussed already. When a http
            request is sent to this page a task variable is sent with it. This is used to determine which action to do.`
        },
        {
            type: 'paragraph',
            text: `If the task is sendEmail we call the sendEmail action(function). This will send a email to the user’s supplied
