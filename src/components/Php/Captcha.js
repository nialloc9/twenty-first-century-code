...
export default () => {
    const data = [
        ...
        },
        {
            type: 'source',
            text: "Github ES6",
            href: 'https://github.com/nialloc9/es6CaptchaGenAndChecker'
        },
        {
            type: 'source',
            text: "Github ES5 with jQuery",
            href: 'https://github.com/nialloc9/captchaImageGeneratorandChecker'
        },
        {
            type: 'paragraph',
        ...
        {
            type: 'paragraph',
            text: `Captchas are used in a wide variety of applications such as preventing comment spam on blogs, protecting
        ...
        {
            type: 'paragraph',
            text: `To see the code including the client side code please follow the links above but in this article we are going
...
?>
        ...
        {
            type: 'paragraph',
            text: `The first and most important action that occurs here is session_start(). This creates or resumes a session and
        ...
        {
            type: 'paragraph',
            text: `The name variable is not actually needed here and we could of just added it inside $_SESSION[] but this application
        ...
        {
            type: 'paragraph',
            text: `When an Ajax request gets sent we create a new session variable with the name captcha (we will look at this in
        ...
        {
            type: 'paragraph',
            text: `Next we create the color for the text. We create a loop that calls the imageline() "function" which draws a line
...
?>
        ...
        {
            type: 'paragraph',
            text: `Again we can see first the session_start() "function" is called. When we receive a get request it is checked for a
        ...
        {
            type: 'paragraph',
            text: `Finally, let’s look at how the session data is checked to whether the user inputted data matches the session data
