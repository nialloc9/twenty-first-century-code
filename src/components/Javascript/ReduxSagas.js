...
class ReduxSagas extends PureComponent{
        ...
        return(
            ...
            >
                ...
                <Block margin={`${remCalc(20)} 0`}>
                    Source code: <a target="_blank" href="https://github.com/nialloc9/redux-sagas-react-native">GitHub</a>
                </Block>

                <Block margin={`${remCalc(20)} 0`}>
                    Recently I decided to look at redux sagas. With a keen interest in redux it seemed only right that I should check out what
...
`
                ...
                <Block margin={`${remCalc(20)} 0`}>
                    The saga will 'yield' at our fetch. It will then pass the data back and be stored in the constant users. This is then passed to the redux-saga helper
...
`
                ...
                <Block margin={`${remCalc(20)} 0`}>
                    Now we have seen how to create a saga we will look at how to add it to our store. As mentioned it will be passed as middleware when creating the store.
                ...
                <Block margin={`${remCalc(20)} 0`}>
                    ...
                    of the api call using a package like <a target="_blank" href="https://www.npmjs.com/package/nock">nock</a>. We can see an example test that shows how clean and easy redux sagas
                    are to test.
                </Block>
