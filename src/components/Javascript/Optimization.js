...
export default () => {
  const data = [
    ...
    {
      type: 'paragraph',
      text: `Optimization of your code can really help performance. It also helps
...
// console.log(v1Result); --> 7`
    ...
    {
      type: 'paragraph',
      text: `The first attempt at the task envolves using brute force to solve the
...
// console.log(maximiseProfitsv2(stocks)); --> 7
    ...
    {
      type: 'paragraph',
      text: `The second attempt cleans up the code by moving the earlyPrice outside
...
// console.log(maximiseProfitsv3(stocks)); --> 7
    ...
    {
      type: 'paragraph',
      text: `The third attempt reduces the time complexity and space complexity by
...
// console.log(maximiseProfitsv4([8, 4, 3, 2])); --> -1
    ...
    {
      type: 'paragraph',
      text: `Another optimization we can do is is to move the minPrice out of the
