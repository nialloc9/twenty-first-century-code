...
export default () => {
    ...
    const data = [
        ...
        {
            type: 'paragraph',
            text: `As a developer who uses react day in day out I am always looking for new ways to do things. Recently I have been looking at how 
...
render() {
    ...
    return onRender ? onRender(props) : cloneElement(Children.only(children), props);
        ...
        {
            type: 'paragraph',
            text: `Above we can see functionality to add a greeting that can be updated dynamically. In this component we are using a 
...
return (
    <div>
        ...
        {
            type: 'paragraph',
            text: `Above we can see how a render callback is passed into our Greeting component. This callback function sets out what to render. 
