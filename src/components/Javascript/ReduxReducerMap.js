...
class ReduxReducerMap extends PureComponent{
    ...
    render(){
        return(
            ...
            >
                ...
                <Block margin={`${remCalc(20)} 0`}>
                    I have been using redux for a couple of years now so I like to think I am quite well versed in implementing it. I have read countless guides on redux and one 
...
`
                ...
                <Block>
                    So above we two ways of creating a traditional reducer. The first using a switch statement where only one case 
...
`
                ...
                <Block margin={`${remCalc(20)} 0`}>
                    With option 3 using a combination of computed properties and ternary statements we achieve a single return statement and have reduced our code by 
                    ...
                    The second is a less obvious reason. It's an optimization. By having functions the new state objects are not stored in memory until they are created. Therefore until the function is invoked at the return 
                    this will not be in the execution context.
                </Block>

                <Block margin={`${remCalc(20)} 0`}>
                    I hope this article has shown you a new way of creating reducers instead of the same implementation on every other tutorial. Check out <SoftLink to="/javascript/redux-push">redux push</SoftLink> if you are interested in redux middleware to handle browser notifications.
                </Block>
