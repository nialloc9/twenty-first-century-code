...
export default () => {
  const data = [
    ...
    {
      type: 'paragraph',
      text: `This is a Java calculator that can do add, subtract, multiply, divide, and get the sin, cos, and tan. Ut has a gui made using the swing package
    ...
    {
      type: 'paragraph',
      text: `This project has three classes that are responsible for different concerns. The gui class is the graphic user interface and allows the user to input data. The Cal class is responsible for the logic of the application.
...
public class Main {
    ...
    {
      type: 'paragraph',
      text: `So if we look at the main class upon running this class a new instance of the graphic user interface is created and a the run method called. Let’s look at this below.`
    },
    {
      type: 'code',
      language: 'java',
...
public class gui implements ActionListener{
   ...
   */
    ...
    {
      type: 'paragraph',
      text: `We can see from when a new instance of the gui is created the "constructor" assigns the data members to new instances of buttons and the calculator gui objects. Then when the run method is called these buttons and
    ...
    {
      type: 'paragraph',
      text: `Now if to find what button operator was clicked. We gave all of our math operator buttons a name when we instantiated them so that when an event is triggered we check the event source to see if it happened on one of
...
public class Cal {
    ...
    {
      type: 'paragraph',
      text: `Because we only can use two numbers in the calculator these are set as final. We do enumeration to add our math operators as constants so they cannot change. We separate these math operators into two separate
